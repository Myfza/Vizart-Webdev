...
},
{
  ...
  features: [
    "3D Grid Environment with dynamic lighting",
    "Intelligent AI opponents that chase the player",
    "Visual trail system for player and AI movements",
    "Dynamic particle systems for interactions",
    "Collapsing grid sections that create obstacles",
    "Multiple power-ups: Speed Boost, AI Flee, Double Damage, Teleport, Extra Life, and Shield",
    "Dynamic starfield backdrop and progressive vertical grid expansion",
    "Dual camera system: Chase Camera and Free Camera modes",
    "Background music (Morse code for 'TRON') that increases in tempo",
    "Time-based scoring with a high score leaderboard",
    "Lives system with the ability to earn extra lives"
  ],
...
},
{
  ...
  features: [
    ...
    "Smooth block rotation and movement mechanics",
    "Automatic block descent with accelerated fall option",
    "Full row deletion with a scoring system",
    "Robust collision detection for blocks and grid boundaries",
    "Game over logic when blocks stack to the top",

  ...
  const techCategories = [
    {
      ...
      technologies: [
        ...
        },
        {
          ...
          color: "from-orange-600 to-white-600",
        },
        {
          name: "Vite",
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto font-poppins px-4 sm:px-0">
            Technologies and tools I use to build intelligent systems, from
            frontend interfaces to AI-powered automation and IoT hardware
            integration
          </p>
        </motion.div>
                ...
                {category.technologies.map((tech, techIndex) => (
                  ...
                  >
                    <div className="relative bg-black/40 backdrop-blur-sm border border-white/10 rounded-xl p-4 sm:p-6 text-center hover:border-white/20 transition-all duration-300 h-full flex flex-col items-center justify-center min-h-[120px] sm:min-h-[140px]">
                      ...
                      <div
                        className={`absolute inset-0 rounded-xl opacity-0 group-hover:opacity-20 bg-gradient-to-br ${tech.color} blur-xl transition-opacity duration-300 -z-10`}
                      ></div>
                    </div>
                  </motion.div>
                ))}
